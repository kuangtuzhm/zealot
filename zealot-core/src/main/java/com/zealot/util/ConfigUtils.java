    ...
    public static Properties getProperties() {
        if (PROPERTIES == null) {
            synchronized (ConfigUtils.class) {
                if (PROPERTIES == null) {
                    String path = System.getProperty(CommonConsts.SYSTEM_PROPERTY_PATH_KEY);
                    if (path == null || path.length() == 0) {
                        path = System.getenv(CommonConsts.SYSTEM_PROPERTY_PATH_KEY);
                        if (path == null || path.length() == 0) {
                            path = CommonConsts.DEFAULT_SYSTEM_PROPERTY_PATH;
                        }
                    }
